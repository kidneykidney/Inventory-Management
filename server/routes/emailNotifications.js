...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      const notifications =
        await notificationService.getNotificationHistory(transactionId);
  ...
  async (req, res) => {
    try {
      ...
      const failedNotifications =
        await notificationService.getFailedNotifications(limit);
...
router.put(
  ...
  [
    ...
    body('overdue_enabled')
      .optional()
      .isBoolean()
      .withMessage('Overdue enabled must be a boolean'),
    body('confirmation_enabled')
      .optional()
      .isBoolean()
      .withMessage('Confirmation enabled must be a boolean'),
