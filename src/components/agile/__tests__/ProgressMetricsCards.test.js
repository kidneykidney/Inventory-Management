...
describe('ProgressMetricsCards', () => {
  ...
  it('renders nothing when no metrics provided', () => {
    const { container } = render(<ProgressMetricsCards metrics={null} sprint={mockSprint} />);
  ...
  it('displays negative velocity trend correctly', () => {
    ...
    render(<ProgressMetricsCards metrics={metricsWithNegativeTrend} sprint={mockSprint} />);
  ...
  it('displays at risk status when sprint is not on track', () => {
    ...
    render(<ProgressMetricsCards metrics={atRiskMetrics} sprint={mockSprint} />);
  ...
  it('shows risk indicators when present', () => {
    ...
    expect(screen.getByText('One team member over-allocated')).toBeInTheDocument();
  });
  ...
  it('shows no risks message when no risks identified', () => {
    ...
    render(<ProgressMetricsCards metrics={noRiskMetrics} sprint={mockSprint} />);
  ...
  it('renders sprint summary card when sprint is provided', () => {
    ...
    expect(screen.getByText('Complete user dashboard features')).toBeInTheDocument();
  ...
  it('shows excellent health for high completion rates', () => {
    ...
    render(<ProgressMetricsCards metrics={excellentMetrics} sprint={mockSprint} />);
  ...
  it('shows needs attention for low completion rates', () => {
    ...
    render(<ProgressMetricsCards metrics={lowProgressMetrics} sprint={mockSprint} />);
  ...
  it('handles over-allocated team utilization correctly', () => {
    ...
    render(<ProgressMetricsCards metrics={overAllocatedMetrics} sprint={mockSprint} />);
  ...
  it('handles missing predictive analytics gracefully', () => {
    ...
    render(<ProgressMetricsCards metrics={metricsWithoutPredictive} sprint={mockSprint} />);
