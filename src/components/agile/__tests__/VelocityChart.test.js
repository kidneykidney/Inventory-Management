...
describe('VelocityChart', () => {
  ...
  it('renders velocity chart with data', () => {
    ...
    expect(screen.getByText('Team Velocity')).toBeInTheDocument();
    expect(
      screen.getByText('Sprint velocity tracking and performance trends')
    ).toBeInTheDocument();
  ...
  it('shows trend indicator for increasing velocity', () => {
    ...
    render(
      <VelocityChart data={increasingData} currentSprint={mockCurrentSprint} />
    );
  ...
  it('shows trend indicator for decreasing velocity', () => {
    ...
    render(
      <VelocityChart data={decreasingData} currentSprint={mockCurrentSprint} />
    );
  ...
  it('handles stable trend correctly', () => {
    ...
    render(
      <VelocityChart data={stableData} currentSprint={mockCurrentSprint} />
    );
  ...
  it('handles insufficient data for trend calculation', () => {
    ...
    render(
      <VelocityChart data={limitedData} currentSprint={mockCurrentSprint} />
    );
  ...
  it('shows confidence level in trend analysis', () => {
    ...
    render(
      <VelocityChart data={longHistoryData} currentSprint={mockCurrentSprint} />
    );
