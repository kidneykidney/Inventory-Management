...
const getToastClasses = (type) => {
  const baseClasses = 'max-w-sm w-full bg-white shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden transform transition-all duration-300 ease-in-out p-4 dark:bg-gray-800';
  ...
  const typeClasses = {
    ...
    warning: 'border-l-4 border-yellow-400 text-yellow-800 dark:text-yellow-200',
