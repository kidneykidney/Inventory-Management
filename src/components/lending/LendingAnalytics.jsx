...
const LendingAnalytics = () => {
  ...
  const fetchAnalytics = async () => {
    try {
      const response = await fetch(
        `/api/v1/lending-transactions/analytics/trends?period=${selectedPeriod}`,
        {
          headers: {
  ...
  const fetchStatistics = async () => {
    try {
      const response = await fetch(
        '/api/v1/lending-transactions/statistics/overview',
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
  ...
  const fetchHistory = async () => {
    try {
      const response = await fetch(
        '/api/v1/lending-transactions/history?limit=100',
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
        ...
        <div className='flex justify-between items-center'>
          <div>
            ...
            <p className='text-gray-600'>
              Comprehensive analytics and insights for the lending system
            </p>
          </div>
              ...
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <p className='text-2xl font-bold'>
                    {statistics.overview.total_transactions}
                  </p>
                </div>
              ...
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <p className='text-2xl font-bold text-blue-600'>
                    {statistics.overview.active_transactions}
                  </p>
                </div>
              ...
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <p className='text-2xl font-bold text-red-600'>
                    {statistics.overview.overdue_transactions}
                  </p>
                </div>
              ...
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <p className='text-2xl font-bold text-green-600'>
                    {Math.round(
                      (statistics.overview.returned_transactions /
                        statistics.overview.total_transactions) *
                        100
                    )}
                    %
                  ...
                  {analytics.topBorrowers.map((user, index) => (
                    ...
                    >
                      ...
                      <div className='text-right'>
                        <p className='font-medium'>
                          {user.total_lendings} total loans
                        </p>
                        <div className='text-sm text-gray-600'>
                          {user.returned_count} returned • {user.overdue_count}{' '}
                          overdue
                        </div>
                        <div className='text-sm text-gray-600'>
