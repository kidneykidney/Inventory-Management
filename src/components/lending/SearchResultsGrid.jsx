...
const SearchResultsGrid = ({ 
  ...
  return (
    <div className={`space-y-6 ${className}`} id="search-results-top" data-testid="search-results">
      {/* Results Header */}
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div className="flex items-center gap-4">
          <div className="text-sm text-gray-600" data-testid="search-results-count">
            {products.length > 0 ? (
              <>
      ...
      {products.length === 0 ? (
        ...
        <>
          {/* Grid View */}
          {viewMode === 'grid' && (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" data-testid="results-grid">
