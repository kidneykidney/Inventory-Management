    ...
    <Card className='glass-card hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer'>
      <CardContent className='p-6'>
        <div className='flex items-start space-x-4'>
          <div
            className={`p-3 rounded-lg bg-gradient-to-br from-${color}-500 to-${color}-600 text-white`}
          >
      ...
      <Card className='glass-card'>
        ...
        <CardContent>
          <div className='space-y-4'>
            {[
              {
                action: 'Product added: Gaming Laptop',
                time: '2 minutes ago',
                type: 'success',
              },
              {
                action: 'Low stock alert: Wireless Mouse',
                time: '15 minutes ago',
                type: 'warning',
              },
              {
                action: 'Order completed: #12345',
                time: '1 hour ago',
                type: 'info',
              },
              {
                action: 'Supplier updated: TechCorp Ltd',
                time: '2 hours ago',
                type: 'info',
              },
            ].map((activity, index) => (
