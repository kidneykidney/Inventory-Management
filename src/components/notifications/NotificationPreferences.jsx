  ...
  return (
    <Card>
      ...
      <CardContent className='space-y-6'>
        <Alert>
          <AlertDescription>
            Configure your email notification preferences for lending
            activities. These settings control when and how you receive email
            notifications.
          </AlertDescription>
        </Alert>
        ...
        <div className='space-y-4'>
          ...
          <div className='flex items-center justify-between'>
            ...
            <Switch
              ...
              onCheckedChange={checked =>
                handlePreferenceChange('reminder_enabled', checked)
              }
          ...
          <div className='flex items-center justify-between'>
            ...
            <Switch
              ...
              onCheckedChange={checked =>
                handlePreferenceChange('overdue_enabled', checked)
              }
              disabled={!preferences.email_enabled}
            />
          </div>
          ...
          <div className='flex items-center justify-between'>
            ...
            <Switch
              ...
              onCheckedChange={checked =>
                handlePreferenceChange('confirmation_enabled', checked)
              }
              disabled={!preferences.email_enabled}
            />
          </div>
          ...
          <div className='space-y-2'>
            ...
            <div className='flex items-center space-x-2'>
              <Input
                ...
                disabled={
                  !preferences.email_enabled || !preferences.reminder_enabled
                }
                className='w-20'
              />
