    ...
    try {
      ...
      const mockData = {
        ...
        burndownData: {
          ...
          planned: [60, 56, 52, 48, 44, 40, 36, 32, 28, 24, 20, 16, 12, 8, 4, 0],
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center space-x-2 mt-2">
              <Progress value={dashboardData.currentSprint.progress} className="flex-1" />
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center space-x-2 mt-2">
              <Progress value={dashboardData.teamMetrics.utilization} className="flex-1" />
            </div>
            <p className="text-xs text-muted-foreground mt-2">
              {dashboardData.teamMetrics.activeMembers}/{dashboardData.teamMetrics.totalMembers} members active
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {dashboardData.currentSprint.completedStories}/{dashboardData.currentSprint.totalStories}
            </div>
            <div className="flex items-center space-x-2 mt-2">
              <Progress 
                value={(dashboardData.currentSprint.completedStories / dashboardData.currentSprint.totalStories) * 100} 
                className="flex-1" 
              />
            </div>
            <p className="text-xs text-muted-foreground mt-2">
