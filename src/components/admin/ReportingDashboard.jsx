    ...
    <div className='space-y-6'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {formatNumber(lendingOverview?.total_transactions)}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {formatNumber(lendingOverview?.active_transactions)}
            </div>
            <div className='flex items-center space-x-1 text-xs text-muted-foreground'>
              <TrendingUp className='h-3 w-3 text-green-500' />
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold text-red-600'>
              {formatNumber(lendingOverview?.overdue_transactions)}
            </div>
            <div className='flex items-center space-x-1 text-xs text-muted-foreground'>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {Math.round(lendingOverview?.avg_lending_period || 0)} days
            </div>
            <div className='flex items-center space-x-1 text-xs text-muted-foreground'>
        ...
        <TabsContent value='overview' className='space-y-4'>
                  ...
                  <PieChart>
                    <Pie
                      data={[
                        {
                          name: 'Active',
                          value: lendingOverview?.active_transactions || 0,
                        },
                        {
                          name: 'Returned',
                          value: lendingOverview?.returned_transactions || 0,
                        },
                        {
                          name: 'Overdue',
                          value: lendingOverview?.overdue_transactions || 0,
                        },
                        {
                          name: 'Lost',
                          value: lendingOverview?.lost_transactions || 0,
                        },
                      ]}
                      cx='50%'
                      cy='50%'
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Key performance indicators for the lending system
              </CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <Card className='lg:col-span-2'>
              ...
              <CardContent>
                <div className='space-y-3'>
                  {overdueAnalysis?.items &&
                  overdueAnalysis.items.length > 0 ? (
