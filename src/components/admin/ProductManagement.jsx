...
const ProductManagement = () => {
  ...
  const getConditionBadge = condition => {
    ...
    return (
      <Badge variant={variants[condition] || 'default'}>{condition}</Badge>
    );
  };
            ...
            <DialogContent className='max-w-2xl'>
              ...
              <div className='space-y-4'>
                ...
                <div className='flex justify-end space-x-2'>
                  ...
                  <Button onClick={handleBulkImport}>Import Products</Button>
                </div>
              </div>
            </DialogContent>
          </Dialog>
              ...
              <form onSubmit={handleAddProduct} className='space-y-4'>
                ...
                <div className='grid grid-cols-2 gap-4'>
                  <div>
                    ...
                    <Select
                      value={newProduct.conditionStatus}
                      onValueChange={value =>
                        setNewProduct({ ...newProduct, conditionStatus: value })
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
                  ...
                  <div>
                    <Label htmlFor='maxLendingPeriod'>
                      Max Lending Period (days)
                    </Label>
                    <Input
                      id='maxLendingPeriod'
                      type='number'
                      ...
                      onChange={e =>
                        setNewProduct({
                          ...newProduct,
                          maxLendingPeriod: parseInt(e.target.value),
                        })
                      }
                    />
                  </div>
            ...
            <form onSubmit={handleEditProduct} className='space-y-4'>
              ...
              <div className='grid grid-cols-2 gap-4'>
                <div>
                  ...
                  <Select
                    value={selectedProduct.conditionStatus}
                    onValueChange={value =>
                      setSelectedProduct({
                        ...selectedProduct,
