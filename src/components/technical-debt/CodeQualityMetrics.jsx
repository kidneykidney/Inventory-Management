    ...
    <div className='p-6 space-y-6'>
      ...
      <div>
        ...
        <p className='text-muted-foreground'>
          Monitor code quality and technical health indicators
        </p>
      </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
        ...
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
            ...
            <div className='flex items-center gap-2'>
              {getTrendIcon(
                qualityMetrics.testCoverage.trend,
                qualityMetrics.testCoverage.change
              )}
              <span className='text-xs text-muted-foreground'>
                {qualityMetrics.testCoverage.change > 0 ? '+' : ''}
                {qualityMetrics.testCoverage.change}%
              </span>
            </div>
          </CardHeader>
          <CardContent>
            <div className='text-2xl font-bold'>
              {qualityMetrics.testCoverage.overall}%
            </div>
            <Progress
            ...
            <div className='flex justify-between text-xs text-muted-foreground mt-2'>
              ...
              <span
                className={getCoverageColor(
                  qualityMetrics.testCoverage.overall,
                  qualityMetrics.testCoverage.target
                )}
              >
                {qualityMetrics.testCoverage.overall >=
                qualityMetrics.testCoverage.target
        ...
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
            ...
            <div className='flex items-center gap-2'>
              {getTrendIcon(
                qualityMetrics.codeComplexity.trend,
                qualityMetrics.codeComplexity.change
              )}
              <span className='text-xs text-muted-foreground'>
                {qualityMetrics.codeComplexity.change > 0 ? '+' : ''}
                {qualityMetrics.codeComplexity.change}
              </span>
            </div>
          </CardHeader>
          <CardContent>
            <div className='text-2xl font-bold'>
              {qualityMetrics.codeComplexity.average}
            </div>
            ...
            <div className='flex justify-between text-xs mt-2'>
              <span className='text-red-600'>
                High: {qualityMetrics.codeComplexity.high}
              </span>
              <span className='text-yellow-600'>
                Medium: {qualityMetrics.codeComplexity.medium}
              </span>
              <span className='text-green-600'>
                Low: {qualityMetrics.codeComplexity.low}
              </span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
            ...
            <div className='flex items-center gap-2'>
              {getTrendIcon(
                qualityMetrics.technicalDebt.trend,
                qualityMetrics.technicalDebt.change
              )}
              <span className='text-xs text-muted-foreground'>
                {qualityMetrics.technicalDebt.change > 0 ? '+' : ''}
                {qualityMetrics.technicalDebt.change}%
              </span>
            </div>
          </CardHeader>
          <CardContent>
            <div className='text-2xl font-bold'>
              {qualityMetrics.technicalDebt.ratio}%
            </div>
            <div className='text-xs text-muted-foreground mt-1'>
        ...
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
            ...
            <div className='flex items-center gap-2'>
              {getTrendIcon(
                qualityMetrics.codeSmells.trend,
                qualityMetrics.codeSmells.change
              )}
              <span className='text-xs text-muted-foreground'>
                {qualityMetrics.codeSmells.change > 0 ? '+' : ''}
                {qualityMetrics.codeSmells.change}
              </span>
            </div>
          </CardHeader>
          <CardContent>
            <div className='text-2xl font-bold'>
              {qualityMetrics.codeSmells.total}
            </div>
            <div className='flex justify-between text-xs mt-2'>
              <span className='text-red-600'>
                Critical: {qualityMetrics.codeSmells.critical}
              </span>
              <span className='text-yellow-600'>
                Major: {qualityMetrics.codeSmells.major}
              </span>
              <span className='text-blue-600'>
                Minor: {qualityMetrics.codeSmells.minor}
              </span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
            ...
            <div className='flex items-center gap-2'>
              {getTrendIcon(
                qualityMetrics.duplicatedCode.trend,
                qualityMetrics.duplicatedCode.change
              )}
              <span className='text-xs text-muted-foreground'>
                {qualityMetrics.duplicatedCode.change > 0 ? '+' : ''}
                {qualityMetrics.duplicatedCode.change}%
              </span>
            </div>
          </CardHeader>
          <CardContent>
            <div className='text-2xl font-bold'>
              {qualityMetrics.duplicatedCode.percentage}%
            </div>
            <div className='text-xs text-muted-foreground mt-1'>
              {qualityMetrics.duplicatedCode.lines} lines in{' '}
              {qualityMetrics.duplicatedCode.blocks} blocks
            </div>
            <Progress
        ...
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
            ...
            <div className='flex items-center gap-2'>
              {getTrendIcon(
                qualityMetrics.maintainabilityIndex.trend,
                qualityMetrics.maintainabilityIndex.change
              )}
              <span className='text-xs text-muted-foreground'>
                {qualityMetrics.maintainabilityIndex.change > 0 ? '+' : ''}
                {qualityMetrics.maintainabilityIndex.change}
              </span>
            </div>
          </CardHeader>
          <CardContent>
            <div className='text-2xl font-bold'>
              {qualityMetrics.maintainabilityIndex.score}
            </div>
            <div className='flex justify-between text-xs mt-2'>
              <span className='text-green-600'>
                Excellent: {qualityMetrics.maintainabilityIndex.excellent}
              </span>
              <span className='text-blue-600'>
                Good: {qualityMetrics.maintainabilityIndex.good}
              </span>
              <span className='text-red-600'>
                Poor: {qualityMetrics.maintainabilityIndex.poor}
              </span>
            </div>
          </CardContent>
        </Card>
