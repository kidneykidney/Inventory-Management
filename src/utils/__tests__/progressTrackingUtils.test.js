...
describe('Progress Tracking Utils', () => {
  ...
  describe('calculateTeamCapacity', () => {
    ...
    it('should handle over-allocation correctly', () => {
      const overAllocatedTeam = [{ capacity: 40, allocated: 50 }];
  ...
  describe('calculateBurnupData', () => {
    ...
    it('should handle scope changes correctly', () => {
      const scopeChanges = [{ points: 5 }, { points: -2 }];
  ...
  describe('generateProgressMetrics', () => {
    ...
    const mockTeamMembers = [{ capacity: 40, allocated: 35 }];
    ...
    it('should identify risk indicators correctly', () => {
      ...
      expect(result.riskIndicators.some(risk => risk.level === 'high')).toBe(
        true
      );
    });
    ...
    it('should generate predictive analytics', () => {
      ...
      expect(['On Time', 'Delayed']).toContain(
        result.predictiveAnalytics.completionForecast
      );
      expect(['low', 'medium', 'high']).toContain(
        result.predictiveAnalytics.confidence
      );
