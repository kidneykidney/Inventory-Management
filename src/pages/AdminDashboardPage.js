    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage your lending system and monitor key metrics</p>
        </div>
        <div className="flex space-x-2">
          <Button variant="outline" onClick={() => handleQuickAction('Export Data')}>
            <Download className="h-4 w-4 mr-2" />
            Export
          </Button>
          <Button variant="outline" onClick={() => handleQuickAction('Import Data')}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{overview?.activeTransactions || 0}</div>
            <p className="text-xs text-muted-foreground">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium">Products Added (30 days)</span>
                  <div className="flex items-center space-x-2">
                    <TrendingUp className="h-4 w-4 text-green-500" />
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium">Lending Success Rate</span>
              ...
              <div className="space-y-4">
                {overdueItems && overdueItems.length > 0 ? (
                  overdueItems.map((item, index) => (
                    <div key={index} className="flex items-center space-x-4 p-3 border border-red-200 rounded-lg bg-red-50">
                      <div className="flex-shrink-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="cursor-pointer hover:shadow-md transition-shadow" 
              ...
              <CardHeader className="text-center">
                ...
                <CardDescription>Add new items to the inventory</CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="cursor-pointer hover:shadow-md transition-shadow" 
              ...
              <CardHeader className="text-center">
                ...
                <CardDescription>Import multiple products at once</CardDescription>
              </CardHeader>
            </Card>
