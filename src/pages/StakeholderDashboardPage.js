          ...
          <CardContent className='space-y-3'>
            <div>
              ...
              <p className='text-sm text-muted-foreground'>
                All metrics are updated in real-time as the development team
                makes progress.
              </p>
            </div>
            <div>
              ...
              <p className='text-sm text-muted-foreground'>
                Use the "Provide Feedback" button to share your thoughts on
                sprint progress, team performance, or suggest improvements.
              </p>
            </div>
            <div>
              <h4 className='font-semibold'>Sprint Health</h4>
              <p className='text-sm text-muted-foreground'>
                Monitor project health through color-coded indicators: Green (on
                track), Yellow (at risk), Red (needs attention).
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className='space-y-3'>
            <div>
              ...
              <p className='text-sm text-muted-foreground'>
                Average story points completed per sprint. Higher velocity
                indicates increased team productivity.
              </p>
            </div>
            <div>
              <h4 className='font-semibold'>Burndown Chart</h4>
              <p className='text-sm text-muted-foreground'>
                Shows remaining work over time. The actual line should track
                close to the planned line for healthy sprint progress.
              </p>
            </div>
            <div>
              <h4 className='font-semibold'>Team Capacity</h4>
              <p className='text-sm text-muted-foreground'>
                Percentage of available team capacity being utilized. Optimal
                range is typically 80-90%.
              </p>
            </div>
          </CardContent>
        </Card>
